...
releases_release_uri = "https://github.com/getweber/cob/tree/%s"
...
project = 'cob'
copyright = '2016, Rotem Yaari'
author = 'Rotem Yaari'

version = release = pkg_resources.get_distribution('cob').version # pylint: disable=no-member
